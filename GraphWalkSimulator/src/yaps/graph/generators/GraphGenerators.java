...
public class GraphGenerators {
	...
	//TODO: rever estes geradores, garantir conexidade, quando possível
	...
	public Graph generateCompleteWeighted(int numVertices, int minWeight, int maxWeight) {
	...
	//TODO: testar se resolver bug antigo - alguns nós com grau ímpar eram gerados
	//TODO: usar técnica mais simples - acrescentar todos os nós, criar algumas repetições e, depois, criar um passeio cíclico
	/**
	 ...
	 */
	public Graph generateUndirectedWeightedEulerian(int numVertices, int minDegree, int maxDegree, int minWeight, int maxWeight) {
		Graph g = new Graph(numVertices, GraphDataRepr.LISTS);
