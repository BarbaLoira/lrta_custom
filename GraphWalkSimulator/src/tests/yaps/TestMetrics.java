...
import yaps.patrolling_metrics.FrequencyMetricsReport;
import yaps.patrolling_metrics.IdlenessMetricsReport;
...
public class TestMetrics {
	...
	public static void main(String[] args) {
		...
		System.out.printf(" - desvio padr�o das visitacoes e das frequencias: %.3f / %.3f \n", freqReport.getStdDevOfVisits(), freqReport.getStdDevOfFrequencies());
